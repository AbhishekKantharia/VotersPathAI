        ...
        <div className="glass-card overflow-hidden">
          ...
          <div className="p-7">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border transition-all text-sm font-medium mb-5 bg-bg-elevated border-border hover:border-primary/30 text-text-primary disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
