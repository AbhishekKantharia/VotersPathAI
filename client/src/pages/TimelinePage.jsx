    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-text-primary">Personalized Timeline</h1>
            <p className="text-xs text-text-muted">Your step-by-step guide to the upcoming elections</p>
          </div>
        </div>
      </div>
      <TimelineEngine />
